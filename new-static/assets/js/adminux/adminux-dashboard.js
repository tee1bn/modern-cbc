/*! For license information please see adminux-dashboard.js.LICENSE.txt */
"use strict";
document.addEventListener("DOMContentLoaded", function () {
  new ProgressBar.Circle(circleprogressblue, {
    ...
    new ProgressBar.Circle(circleprogressred, {
      color: "#c80036",
      strokeWidth: 10,
      trailWidth: 10,
      easing: "easeInOut",
  ...
  var t = document.getElementById("smallchart2").getContext("2d"),
    a = t.createLinearGradient(0, 0, 0, 90);
  a.addColorStop(0, "rgba(200, 0, 54, 0.75)"),
    a.addColorStop(0.45, "rgba(200, 0, 54, 0.5)"),
    a.addColorStop(1, "rgb(241, 157, 0, 0)");
  var r = {
      type: "line",
      data: {
